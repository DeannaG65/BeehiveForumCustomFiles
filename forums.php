...
if (session::logged_in()) {
    ...
    echo "                    <table class=\"postbody\" width=\"95%\">\n";
    echo "                      <tr>\n";
    echo "                        <td class=\"postbody\" align=\"left\">", gettext("Forum Name"), ": ", form_input_text("webtag_search", (isset($webtag_search) ? htmlentities_array($webtag_search) : ""), 30, 64), " ", form_submit('search', gettext("Search")), " ", form_submit('clear_search', gettext("Clear")), "</td>\n";
    echo "                      </tr>\n";
    echo "                    </table>\n";
    echo "                  </td>\n";
    echo "                </tr>\n";
