...
function thread_list_draw_top($mode, $folder = false)
{
    ...
    echo "<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"postbody\">\n";
    echo "  <tr>\n";
    echo "    <td align=\"left\">", html_style_image('post', gettext("New Discussion")), "&nbsp;<a href=\"post.php?webtag=$webtag\" target=\"", html_get_frame_name('main'), "\">", gettext("New Discussion"), "</a></td>\n";
    echo "  </tr>\n";

    if (forum_get_setting('allow_polls', 'Y')) {

        echo "  <tr>\n";
        echo "    <td align=\"left\">", html_style_image('poll', gettext("Create Poll")), "&nbsp;<a href=\"create_poll.php?webtag=$webtag\" target=\"", html_get_frame_name('main'), "\">", gettext("Create Poll"), "</a></td>\n";
        echo "  </tr>\n";
    }

    echo "  <tr>\n";
    echo "    <td align=\"left\">", html_style_image('search', gettext("Search")), "&nbsp;<a href=\"search.php?webtag=$webtag\" target=\"", html_get_frame_name('right'), "\">", gettext("Search"), "</a></td>\n";
    echo "  </tr>\n";
    echo "  <tr>\n";
    echo "    <td align=\"left\">", html_style_image('pm_unread', gettext("Inbox")), "&nbsp;<a href=\"pm.php?webtag=$webtag\" target=\"", html_get_frame_name('main'), "\">", gettext("Inbox"), "</a> <span class=\"pmnewcount\" id=\"pm_message_count\"></span></td>\n";

//MY ADDITION VISITOR LOG LINK
    echo "  </tr>\n";
    echo "  <tr>\n";
    echo "    <td align=\"left\">", html_style_image('bigstar', gettext("Visitor Log")), "&nbsp;<a href=\"visitor_log.php?webtag=$webtag&amp;show=visitors\" target=\"", html_get_frame_name('right'), "\">", gettext("Visitor Log"), "</a></td>\n";
