...
if ($thread_data['DELETED'] == 'N') {
    ...
    echo "                      <tr>\n";
    echo "                        <td align=\"left\" width=\"260\" class=\"postbody\">", gettext("Marked as read"), ":</td>\n";
    ...
    echo "                      </tr>\n";
    echo "                      <tr>\n";
    echo "                        <td align=\"left\" valign=\"top\" class=\"postbody\">", gettext("Interest"), ":</td>\n";
    ...
    if (session::check_perm(USER_PERM_FOLDER_MODERATE, $folder_data['FID']) || (($thread_data['BY_UID'] == $_SESSION['UID']) && ($thread_data['ADMIN_LOCK'] != THREAD_ADMIN_LOCK_ENABLED) && forum_get_setting('allow_post_editing', 'Y') && ((intval(forum_get_setting('post_edit_time', 'is_numeric', 0)) == 0) || ((time() - $thread_data['CREATED']) < (intval(forum_get_setting('post_edit_time', 'is_numeric', 0) * MINUTE_IN_SECONDS)))))) {
        ...
        if (!thread_is_poll($tid)) {
            ...
            echo "                    <table class=\"posthead\" width=\"95%\">\n";
            echo "                      <tr>\n";
            echo "                        <td align=\"left\" width=\"260\" class=\"postbody\">", gettext("Rename thread"), ":</td>\n";
            echo "                        <td align=\"left\">", form_input_text("rename", htmlentities_array($thread_data['TITLE']), 37, 64), "</td>\n";
            echo "                      </tr>\n";
            echo "                      <tr>\n";
            echo "                        <td align=\"left\" class=\"postbody\">", gettext("Move thread"), ":</td>\n";
        ...
        if (session::check_perm(USER_PERM_FOLDER_MODERATE, $folder_data['FID'])) {
            ...
            if (thread_is_poll($tid) && $thread_available_pids) {
                ...
                echo "                      <tr>\n";
                echo "                        <td align=\"left\">&nbsp;</td>\n";
                echo "                        <td align=\"left\" class=\"postbody\">", form_radio("split_type", THREAD_SPLIT_REPLIES, gettext("Selected post and replies only")), "</td>\n";
                echo "                      </tr>\n";
                echo "                      <tr>\n";
                echo "                        <td align=\"left\">&nbsp;</td>\n";
                echo "                        <td align=\"left\" class=\"postbody\">", form_radio("split_type", THREAD_SPLIT_FOLLOWING, gettext("Selected and all following posts")), "</td>\n";
                echo "                      </tr>\n";
                echo "                      <tr>\n";
                echo "                        <td align=\"left\">&nbsp;</td>\n";
                ...
                echo "                      <tr>\n";
                echo "                        <td align=\"left\">&nbsp;</td>\n";
                echo "                        <td align=\"left\" class=\"postbody\">", form_radio("merge_type", THREAD_MERGE_START, gettext("Posts in this thread at start")), "</td>\n";
                echo "                      </tr>\n";
                echo "                      <tr>\n";
                echo "                        <td align=\"left\">&nbsp;</td>\n";
                echo "                        <td align=\"left\" class=\"postbody\">", form_radio("merge_type", THREAD_MERGE_END, gettext("Posts in this thread at end")), "</td>\n";
                echo "                      </tr>\n";
                echo "                      <tr>\n";
                echo "                        <td align=\"left\">&nbsp;</td>\n";
                echo "                        <td align=\"left\" class=\"postbody\">", form_radio("merge_type", THREAD_MERGE_BY_CREATED, gettext("Re-order posts into date order")), "</td>\n";
                echo "                      </tr>\n";
                echo "                      <tr>\n";
                echo "                        <td align=\"left\">&nbsp;</td>\n";
                ...
                echo "                      <tr>\n";
                echo "                        <td align=\"left\">&nbsp;</td>\n";
                echo "                        <td align=\"left\" class=\"postbody\">", form_radio("merge_type", THREAD_MERGE_START, gettext("Posts in this thread at end")), "</td>\n";
                echo "                      </tr>\n";
                echo "                      <tr>\n";
                echo "                        <td align=\"left\">&nbsp;</td>\n";
                echo "                        <td align=\"left\" class=\"postbody\">", form_radio("merge_type", THREAD_MERGE_BY_CREATED, gettext("Re-order posts into date order")), "</td>\n";
            ...
            echo "                    <table class=\"posthead\" width=\"95%\">\n";
            echo "                      <tr>\n";
            echo "                        <td align=\"left\" width=\"150\" class=\"postbody\">", gettext("Sticky"), ":</td>\n";
            ...
            echo "                    <table class=\"posthead\" width=\"95%\">\n";
            echo "                      <tr>\n";
            echo "                        <td align=\"left\" class=\"postbody\">", gettext("Closed for posting"), ":</td>\n";
            echo "                        <td align=\"left\">\n";
            ...
            echo "                      </tr>\n";
            echo "                      <tr>\n";
            echo "                        <td align=\"left\" class=\"postbody\">", gettext("Lock title and folder"), ":</td>\n";
            echo "                        <td align=\"left\">\n";
            ...
            echo "                    <table class=\"posthead\" width=\"95%\">\n";
            echo "                      <tr>\n";
            echo "                        <td align=\"left\" class=\"postbody\" width=\"260\">", gettext("Delete posts in thread by user"), ":</td>\n";
            echo "                        <td align=\"left\" class=\"postbody\">", post_draw_to_dropdown_in_thread($tid, 0, false, true, 'bhselect', 'style="width: 275px"'), "</td>\n";
            echo "                      </tr>\n";
            echo "                      <tr>\n";
            echo "                        <td align=\"left\">&nbsp;</td>\n";
            echo "                        <td align=\"left\" class=\"postbody\">", form_checkbox("deluser_con", "Y", gettext("Confirm")), "</td>\n";
            echo "                      </tr>\n";
            echo "                      <tr>\n";
            echo "                        <td align=\"left\">&nbsp;</td>\n";
            echo "                        <td align=\"left\">&nbsp;</td>\n";
            ...
            echo "                    <table class=\"posthead\" width=\"95%\">\n";
            echo "                      <tr>\n";
            echo "                        <td align=\"left\" class=\"postbody\" width=\"260\">", gettext("Delete Thread"), ":</td>\n";
            echo "                        <td align=\"left\" class=\"postbody\">", form_radio("delete_thread", -1, gettext("No"), true), "</td>\n";
            echo "                      </tr>\n";
            echo "                      <tr>\n";
            echo "                        <td align=\"left\">&nbsp;</td>\n";
            echo "                        <td align=\"left\" class=\"postbody\">", form_radio("delete_thread", THREAD_DELETE_PERMENANT, gettext("Permanently Delete")), "</td>\n";
            echo "                      </tr>\n";
            echo "                      <tr>\n";
            echo "                        <td align=\"left\">&nbsp;</td>\n";
            echo "                        <td align=\"left\" class=\"postbody\">", form_radio("delete_thread", THREAD_DELETE_NON_PERMENANT, gettext("Move to Deleted Threads")), "</td>\n";
            echo "                      </tr>\n";
            echo "                      <tr>\n";
            echo "                        <td align=\"left\">&nbsp;</td>\n";
            echo "                        <td align=\"left\" class=\"postbody\">", form_checkbox("delete_thread_confirm", "Y", gettext("Confirm")), "</td>\n";
            echo "                      </tr>\n";
            echo "                      <tr>\n";
            echo "                        <td align=\"left\">&nbsp;</td>\n";
            echo "                        <td align=\"left\">&nbsp;</td>\n";
